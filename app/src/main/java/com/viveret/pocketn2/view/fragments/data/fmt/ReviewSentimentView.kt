...
class ReviewSentimentView : DataFormatView {
    override val nameResId: Int = R.string.title_fragment_data_view_review_sentiment

    override fun supportsData(data: DataSlice): Boolean = data[DataRole.Input]!!.first.vals.size >= 300
